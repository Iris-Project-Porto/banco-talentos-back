...
public class ProfileController {
    ...
    @PostMapping
    @Operation(summary = "Criar ou atualizar perfil", description = "Submete o perfil para análise (status PENDENTE). A IA avalia e classifica o nível automaticamente.")
    public Profile submit(@RequestBody ProfileRequest req, Authentication auth) {
